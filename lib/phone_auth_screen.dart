...
//     _getUserByIdUseCase = GetUserByIdUseCase(userRepository);
//   }
...
//         int tokens = AppConstants.defaultTokenCount;
//         final existing = await _getUserByIdUseCase(userCredential.user!.uid);
//         if (existing != null) {
